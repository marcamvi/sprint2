...
db.restaurants.find({$and:[{"grades.score": { $lt : 100}}, {"grades.score": {$gt : 80}}
        ]}).pretty()
...
/*11. Escriu una consulta de MongoDB per a trobar els restaurants que no cuinen  menjar 'American' i 
tenen algun score superior a 70 i latitud inferior a -65.754168*/
db.restaurants.find({"cuisine": {$ne : "American "}, "grades.score": {$gt : 70},"address.coord.0":{ $lt : -65.754168}}).pretty()
/*12. Escriu una consulta per trobar els restaurants que no preparen menjar 'American' i 
 * tenen algun score superior a 70 i que, a més,  és localitzen en longituds inferiors a -65.754168. 
...
/*14. Escriu una consulta per trobar el restaurant_id, name, borough i cuisine per a aquells restaurants que contenen 'Wil' en les tres primeres lletres 
en el seu nom*/
...
contenen 'ces' en les últimes tres lletres en el seu nom*/
...
preparen marisc ('seafood') excepte si son 'American', 'Chinese' o el name del restaurant comença amb lletres 'Wil'*/


/*22. Escriu una consulta per trobar el restaurant_id, name i grades per a aquells restaurants que 
aconsegueixin un grade de "A" i un score de 11 amb un ISODate "2014-08-11T00:00:00Z"*/
...
el segon element del array coord conté un valor entre 42 i 52*/
